...
require 'verificar-confirmacao-vista.php';
?>
<!DOCTYPE HTML>
<html>
<head>
			...
			<div class="top-nav">
				<div class="top-nav-left">
					<ul>
						...
						<li><a href="sobre-nos-user.php">Sobre nós</a></li>
						<li><a href="servicos-user.php">Serviços</a></li>
						<li><a href="contactos-user.php">Contactos</a></li>
