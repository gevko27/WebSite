   ...
   <!----End-header----->
		 ...
		 <div class="content">
		 	...
		 	<div class="about-us">
		 			<div class="wrap">
						<div>
						<h4>Registo realizado com sucesso! Deverá ter recebido um e-mail com a confirmação da conta, ao executar o login por favor insira o código que lhe foi enviado por mail!</h4><br>
							<h3>Login</h3><br>
							<div class="clear"> </div>

	<form name="login-form" class="login-form" action="login-bd.php" method="get">
